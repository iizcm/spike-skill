---
title: Spike - Skill
description: AI Agent Skill for throwaway experiments, proof-of-concept, feasibility validation
---
...
**English:**
A universal AI agent skill that enables your agent to handle **throwaway experiments, proof-of-concept, feasibility validation**. Works with any AI agent platform (Hermes, Claude Code, OpenClaw, etc.).

**Bahasa Indonesia:**
Skill AI agent universal yang memungkinkan agen Anda menangani **throwaway experiments, proof-of-concept, feasibility validation**. Bekerja dengan semua platform AI agent (Hermes, Claude Code, OpenClaw, dll).

## Installation / Instalasi

### Hermes Agent
```bash
hermes skills install https://raw.githubusercontent.com/iizcm/spike-skill/main/SKILL.md --name spike --yes
```

### Manual / Universal
Place `SKILL.md` in your agent's skills directory:
```
~/.<your-platform>/skills/spike/SKILL.md
```
